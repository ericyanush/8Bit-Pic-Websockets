...
#define STACK_USE_DHCP_CLIENT			// Dynamic Host Configuration Protocol client for obtaining IP address and other parameter//#define STACK_USE_DHCP_SERVER			// Single host DHCP server
 ...
 */
#define MY_DEFAULT_HOST_NAME			"PICWEBSOCKETSDEMO"
...
#define MY_DEFAULT_IP_ADDR_BYTE4        (199ul)
